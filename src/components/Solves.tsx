...
//         } w-full h-full justify-center items-center text-[4em] text-[#80808080] overflow-hidden`}
//       >
//         NO SOLVES
//       </div>
//       <div
...
//                     key={index}
//                     onClick={() => clearAll()}
//                     className={`p-2 border-[2px] border-dotted hover:border-solid border-[#80808016] hover:bg-[#80808032] text-center font-bold cursor-pointer select-none rounded-md`}
//                   >
//                     CLEAR
//                   </p>
//                   <span
//                     key={index}
//                     className="p-4 border-[2px] border-dotted hover:border-solid border-[#80808016] hover:bg-[#80808032] flex flex-row items-center gap-2 rounded-md"
//                   >
...
//                         className={`h-6 ${
//                           !darkMode
//                             ? "fill-[#808080] hover:fill-black"
//                             : "fill-[#808080] hover:fill-white"
//                         } cursor-pointer`}
//                         viewBox="0 0 24 24"
//                       >
...
//                     </span>
//                     <p
//                       className={`text-[#808080] flex items-center font-semibold whitespace-nowrap`}
//                     >
//                       {scrambles[originalIndex]}
//                     </p>
//                   </span>
//                 </>
//               ) : (
...
const Solves: React.FC = () => {
  ...
  const SolveItem: React.FC<SolveItemProps> = ({
    ...
    <span
      key={index}
      className="flex flex-row items-center p-4 gap-2 border-[2px] border-dotted hover:border-solid border-[#80808016] hover:bg-[#80808032] rounded-md"
    >
              ...
              return (
                <div key={index}>
                  {index === 0 && (
                    <p
                      onClick={() => clearAll()}
                      className={`mb-[18px] p-2 border-[2px] border-dotted hover:border-solid border-[#80808016] hover:bg-[#80808032] font-bold text-center cursor-pointer select-none rounded-md`}
                    >
                      CLEAR
                    </p>
                  )}
